...
lazy_static! {
    pub static ref QUEUE_TREE_MAPPING: HashMap<String, TreeInfo> = {
        ...
        m.insert(
            "47XabVBHzJ1ZZ5fjvMsYfZasqjxGdc3kL1x7nRcPSePi".to_string(),
            TreeInfo {
                tree: pubkey!("47XabVBHzJ1ZZ5fjvMsYfZasqjxGdc3kL1x7nRcPSePi"),
                queue: pubkey!("ArXpCNXx4kgp6qRgo6fMLbSC9oyyxogXew8YUaZpNbio"),
                height: 32,
                tree_type: TreeType::StateV2,
            },
        );
        ...
        m.insert(
            "ArXpCNXx4kgp6qRgo6fMLbSC9oyyxogXew8YUaZpNbio".to_string(),
            TreeInfo {
                tree: pubkey!("47XabVBHzJ1ZZ5fjvMsYfZasqjxGdc3kL1x7nRcPSePi"),
                queue: pubkey!("ArXpCNXx4kgp6qRgo6fMLbSC9oyyxogXew8YUaZpNbio"),
                height: 32,
        ...
        m.insert(
            "EaVSy5Ai1zH1mDcMZDWaaauCzZv1ecV6xz9kK4dDjk8A".to_string(),
            TreeInfo {
                tree: pubkey!("EaVSy5Ai1zH1mDcMZDWaaauCzZv1ecV6xz9kK4dDjk8A"),
                queue: pubkey!("FenwGGDZh6q9yioEqFAZKGU1Ntg2LmCkJVbagjzzDKWb"),
                height: 32,
                tree_type: TreeType::StateV2,
            },
        );
        ...
        m.insert(
            "FenwGGDZh6q9yioEqFAZKGU1Ntg2LmCkJVbagjzzDKWb".to_string(),
            TreeInfo {
                tree: pubkey!("EaVSy5Ai1zH1mDcMZDWaaauCzZv1ecV6xz9kK4dDjk8A"),
                queue: pubkey!("FenwGGDZh6q9yioEqFAZKGU1Ntg2LmCkJVbagjzzDKWb"),
                height: 32,
        ...
        m.insert(
            "9fVjot7AYKwsisreuyQ8ypE8LvyA4ocmFrhbAw2uiEzn".to_string(),
            TreeInfo {
                tree: pubkey!("9fVjot7AYKwsisreuyQ8ypE8LvyA4ocmFrhbAw2uiEzn"),
                queue: pubkey!("4Xm3n1zncUZXwfzUPHar5aFMs5PFTkjrz7KCEcjJtERb"),
                height: 32,
                tree_type: TreeType::StateV2,
            },
        );
        ...
        m.insert(
            "4Xm3n1zncUZXwfzUPHar5aFMs5PFTkjrz7KCEcjJtERb".to_string(),
            TreeInfo {
                tree: pubkey!("9fVjot7AYKwsisreuyQ8ypE8LvyA4ocmFrhbAw2uiEzn"),
                queue: pubkey!("4Xm3n1zncUZXwfzUPHar5aFMs5PFTkjrz7KCEcjJtERb"),
                height: 32,
        ...
        m.insert(
            "6QtGq5Qd5AN1MpD1tWRVg6B13yZUVevXV126jRN1vKP8".to_string(),
            TreeInfo {
                tree: pubkey!("6QtGq5Qd5AN1MpD1tWRVg6B13yZUVevXV126jRN1vKP8"),
                queue: pubkey!("7zGUfnSHut3UW4PpFM6EAbjquF4MKo93foPxhRV1ooxT"),
                height: 32,
                tree_type: TreeType::StateV2,
            },
        );
        ...
        m.insert(
            "7zGUfnSHut3UW4PpFM6EAbjquF4MKo93foPxhRV1ooxT".to_string(),
            TreeInfo {
                tree: pubkey!("6QtGq5Qd5AN1MpD1tWRVg6B13yZUVevXV126jRN1vKP8"),
                queue: pubkey!("7zGUfnSHut3UW4PpFM6EAbjquF4MKo93foPxhRV1ooxT"),
                height: 32,
        ...
        m.insert(
            ...
            TreeInfo {
                ...
                queue: pubkey!("DFp2gBJRVCFumMTCAWqX8dkQrzSiKn6AMKVDyppL5pbV"),
                height: 40,
                tree_type: TreeType::AddressV2,
            },
        );
        ...
        m.insert(
            "AcgJj3C8g5dGzyNPfhTkeQGDjUY4zPGPCujZj9Dc9tXY".to_string(),
            TreeInfo {
                tree: pubkey!("AcgJj3C8g5dGzyNPfhTkeQGDjUY4zPGPCujZj9Dc9tXY"),
                queue: pubkey!("AcgJj3C8g5dGzyNPfhTkeQGDjUY4zPGPCujZj9Dc9tXY"),
                height: 40,
                tree_type: TreeType::AddressV2,
            },
        );
        ...
        m.insert(
            "ACef6Ge9GVyPbSuaUvqX47akLWWVAnYMyYSrhD2D9JGJ".to_string(),
            TreeInfo {
        ...
        m.insert(
            "C7g8NqRsEDhi3v9AyVpCfL16YYdHPhrR74douckfrhqu".to_string(),
            TreeInfo {
                tree: pubkey!("C7g8NqRsEDhi3v9AyVpCfL16YYdHPhrR74douckfrhqu"),
                queue: pubkey!("C7g8NqRsEDhi3v9AyVpCfL16YYdHPhrR74douckfrhqu"),
                height: 40,
                tree_type: TreeType::AddressV2,
            },
        );
